        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingContact = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SA_SalesQuotation", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SA_SalesQuotationItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SA_SalesQuotationItem_SA_SalesQuotation_SalesQuotationId",
                        column: x => x.SalesQuotationId,
                        principalTable: "SA_SalesQuotation",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SA_SalesQuotationItem_SalesQuotationId",
                table: "SA_SalesQuotationItem",
